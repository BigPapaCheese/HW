...
int main()
{
	...
	for(int i = 0; i < ENTIRE_DATA_SET; i += DATA_CHUNKS*2)
	{
        ...
        cudaMemcpyAsync( C0_GPU, C_CPU +i,DATA_CHUNKS*sizeof(float),
        ...
        trigAdditionGPU<<<DATA_CHUNKS/BLOCK_SIZE,BLOCK_SIZE,0,Stream0>>>(A1_GPU, B1_GPU,C1_GPU, DATA_CHUNKS);
    
        cudaMemcpyAsync( C1_GPU, C_CPU +i+DATA_CHUNKS,DATA_CHUNKS*sizeof(float),
